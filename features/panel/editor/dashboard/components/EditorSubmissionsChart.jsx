...
export default function EditorSubmissionsChart({ data, isLoading }) {
  if (isLoading) {
    return (
      <Card>
        <CardHeader>
  ...
  const chartData = [
    {
      name: "Accepted",
      value: data.accepted_submissions,
      color: COLORS.accepted,
    },
    {
      name: "Rejected",
      value: data.rejected_submissions,
      color: COLORS.rejected,
    },
    {
      name: "Under Review",
      value: data.under_review_submissions,
      color: COLORS.under_review,
    },
    { name: "Pending", value: data.pending_submissions, color: COLORS.pending },
