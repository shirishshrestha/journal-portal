...
import { useAddProductionParticipant } from "../../hooks";

/**
 * Dialog to add a participant to an existing production assignment
 * Uses the POST /api/v1/submissions/production/assignments/{id}/add_participant/ endpoint
 */
export function AddProductionParticipantDialog({
  isOpen,
  onClose,
  assignmentId,
}) {
  ...
  const addParticipant = useAddProductionParticipant();
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Add an additional participant or collaborator to this production
            assignment
          </DialogDescription>
        </DialogHeader>
