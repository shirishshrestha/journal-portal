        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-muted-foreground">{submission?.submission_number}</p>
            </div>
          ...
          <CardContent>
            {reviewType === 'SINGLE_BLIND' ? (
              <div className="text-center py-8 border-2 border-dashed rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Reviewer identities are kept confidential from authors during the review process.
                  Reviewer recommendations are not displayed to maintain the integrity of the blind review.
                </p>
              </div>
              ...
              <div className="text-center py-8 border-2 border-dashed rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  Both reviewer and author identities are kept confidential during the review process.
                  Reviewer recommendations are not displayed to maintain the integrity of the blind review.
                </p>
              </div>
              ...
              <div className="text-center py-8 border-2 border-dashed rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  The system couldn't find suitable reviewer recommendations for this submission
                </p>
              </div>
            ) : (
              <div className="space-y-4">
                {recommendations.recommendations.slice(0, 5).map((reviewer, index) => {
                  // Access scores object
                  const compositeScore = reviewer.scores?.composite;
                  const similarityScore = reviewer.scores?.similarity;
                  const scorePercent = compositeScore ? (compositeScore * 100).toFixed(1) : null;
                          ...
                          <div className="flex flex-wrap gap-3 mt-2 text-xs">
                            ...
                            {reviewer.scores.availability != null && (
                              <div className="flex items-center gap-1 text-muted-foreground">
                                ...
                                <span>{(reviewer.scores.availability * 100).toFixed(0)}%</span>
                              </div>
                            )}
                            {reviewer.scores.quality != null && (
                              <div className="flex items-center gap-1 text-muted-foreground">
                                <span className="font-medium">Quality:</span>
                                <span>{(reviewer.scores.quality * 100).toFixed(0)}%</span>
                              </div>
                            )}
                          </div>
                        )}
